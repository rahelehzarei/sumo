...
def getBasicStats(verbose, method, vehicles, assignments):
    ...
    data = [["totalVeh", "totalTravelTime", "totalTravelLength","totalDepartDelay", "totalWaitTime", "avgTravelTime",
            "avgTravelLength", "avgTravelSpeed", "avgDepartDelay"],[totalVeh, totalTravelTime, totalTravelLength,totalDepartDelay, totalWaitTime, avgTravelTime, avgTravelLength, avgTravelSpeed, avgDepartDelay]]
    ...
    # with open('stat','w') as statistic_file:
    #     statistic_file.write("totalVeh", "totalTravelTime", "totalTravelLength","totalDepartDelay", "totalWaitTime", "avgTravelTime",
    #                              "avgTravelLength", "avgTravelSpeed", "avgDepartDelay")
    #     statistic_file.write(totalVeh, totalTravelTime, totalTravelLength, totalDepartDelay, totalWaitTime, avgTravelTime,
    #                              avgTravelLength, avgTravelSpeed, avgDepartDelay)
...
optParser.add_option("-t", "--tripinform-file", dest="vehfile",
                     ...
                     metavar="FILE")
optParser.add_option("-o", "--output-file", dest="outputfile", default="Global_MOE.xml",
